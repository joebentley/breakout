...
Void Stage_obj::__onTouch( Dynamic event,::String type,::flash::display::TouchInfo touchInfo){
{
		...
		if (((stack->length > (int)0))){
			...
			HX_STACK_LINE(986)
			::flash::geom::Point _g2 = ::flash::geom::Point_obj::__new(event->__Field(HX_CSTRING("x"),true),event->__Field(HX_CSTRING("y"),true));		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(986)
			::flash::events::TouchEvent touchEvent = ::flash::events::TouchEvent_obj::__create(type,event,_g2,null(),event->__Field(HX_CSTRING("scaleX"),true),event->__Field(HX_CSTRING("scaleY"),true));		HX_STACK_VAR(touchEvent,"touchEvent");
			HX_STACK_LINE(987)
			touchEvent->touchPointID = event->__Field(HX_CSTRING("value"),true);
			HX_STACK_LINE(988)
			touchEvent->isPrimaryTouchPoint = (((int(event->__Field(HX_CSTRING("flags"),true)) & int((int)32768))) > (int)0);
...
int Stage_obj::get_stageHeight( ){
	HX_STACK_FRAME("flash.display.Stage","get_stageHeight",0xe188cca2,"flash.display.Stage.get_stageHeight","flash/display/Stage.hx",1312,0x8d64160c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1314)
...
int Stage_obj::get_stageWidth( ){
	HX_STACK_FRAME("flash.display.Stage","get_stageWidth",0xac6421ab,"flash.display.Stage.get_stageWidth","flash/display/Stage.hx",1319,0x8d64160c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1321)
	Float _g;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1321)
