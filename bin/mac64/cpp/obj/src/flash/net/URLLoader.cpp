...
{
		HX_STACK_FRAME("flash.net.URLLoader","dispatchHTTPStatus",0xad78016f,"flash.net.URLLoader.dispatchHTTPStatus","flash/net/URLLoader.hx",144,0xf174b5ed)
		HX_STACK_THIS(this)
		HX_STACK_ARG(code,"code")
		HX_STACK_LINE(146)
		::flash::events::HTTPStatusEvent _g = ::flash::events::HTTPStatusEvent_obj::__new(::flash::events::HTTPStatusEvent_obj::HTTP_STATUS,false,false,code);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(146)
		this->dispatchEvent(_g);
	}
return null();
