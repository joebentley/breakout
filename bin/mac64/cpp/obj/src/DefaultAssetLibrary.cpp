...
HX_STACK_FRAME("DefaultAssetLibrary","new",0xbc37e41e,"DefaultAssetLibrary.new","DefaultAssetLibrary.hx",34,0x0fc48912)
{
	...
	HX_STACK_CATCHABLE(Dynamic, 0);
	{
		...
		if (((bytes != null()))){
			...
			HX_STACK_LINE(142)
			::haxe::Log_obj::trace(HX_CSTRING("Warning: Could not load asset manifest"),hx::SourceInfo(HX_CSTRING("DefaultAssetLibrary.hx"),142,HX_CSTRING("DefaultAssetLibrary"),HX_CSTRING("new")));
		}
	}
	}
	catch(Dynamic __e){
		{
			...
			Dynamic e = __e;{
				HX_STACK_LINE(148)
				::haxe::Log_obj::trace(HX_CSTRING("Warning: Could not load asset manifest"),hx::SourceInfo(HX_CSTRING("DefaultAssetLibrary.hx"),148,HX_CSTRING("DefaultAssetLibrary"),HX_CSTRING("new")));
			}
		}
	}
}
...
::flash::display::BitmapData DefaultAssetLibrary_obj::getBitmapData( ::String id){
	...
	HX_STACK_LINE(246)
	return ::flash::display::BitmapData_obj::load(_g,null());
}


::flash::utils::ByteArray DefaultAssetLibrary_obj::getBytes( ::String id){
	HX_STACK_FRAME("DefaultAssetLibrary","getBytes",0x86b4b377,"DefaultAssetLibrary.getBytes","DefaultAssetLibrary.hx",253,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(299)
	::String _g = ::DefaultAssetLibrary_obj::path->get(id);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(299)
	return ::flash::utils::ByteArray_obj::readFile(_g);
}
...
::flash::media::Sound DefaultAssetLibrary_obj::getMusic( ::String id){
	...
	::String _g = ::DefaultAssetLibrary_obj::path->get(id);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(348)
	::flash::net::URLRequest _g1 = ::flash::net::URLRequest_obj::__new(_g);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(348)
	return ::flash::media::Sound_obj::__new(_g1,null(),true);
}
...
::flash::media::Sound DefaultAssetLibrary_obj::getSound( ::String id){
	...
	::flash::net::URLRequest _g1 = ::flash::net::URLRequest_obj::__new(_g);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(386)
	::openfl::AssetType _g2 = ::DefaultAssetLibrary_obj::type->get(id);		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(386)
	bool _g3 = (_g2 == ::openfl::AssetType_obj::MUSIC);		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(386)
	return ::flash::media::Sound_obj::__new(_g1,null(),_g3);
}
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadBitmapData",0x9243e881,"DefaultAssetLibrary.loadBitmapData","DefaultAssetLibrary.hx",460,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadBytes",0x8c71caa3,"DefaultAssetLibrary.loadBytes","DefaultAssetLibrary.hx",493,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(523)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadFont",0x1da5ca97,"DefaultAssetLibrary.loadFont","DefaultAssetLibrary.hx",530,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(552)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadMusic",0xdf3492dd,"DefaultAssetLibrary.loadMusic","DefaultAssetLibrary.hx",559,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(581)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadSound",0x4fa64f07,"DefaultAssetLibrary.loadSound","DefaultAssetLibrary.hx",588,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(610)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadText",0x26df3975,"DefaultAssetLibrary.loadText","DefaultAssetLibrary.hx",617,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(617)
		...
		Void run(::flash::utils::ByteArray bytes){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","DefaultAssetLibrary.hx",641,0x0fc48912)
