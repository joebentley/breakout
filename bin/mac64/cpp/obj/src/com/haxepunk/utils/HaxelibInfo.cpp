...
struct _Function_0_1{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/utils/HaxelibInfo.hx",104,0x1e9631e8)
		{
			hx::Anon __result = hx::Anon_obj::Create();
			__result->Add(HX_CSTRING("openfl") , HX_CSTRING("1.3.0"),false);
			__result->Add(HX_CSTRING("openfl-native") , HX_CSTRING("1.3.0"),false);
			__result->Add(HX_CSTRING("lime-tools") , HX_CSTRING("1.3.2"),false);
			__result->Add(HX_CSTRING("openfl-html5") , HX_CSTRING("1.1.0-beta"),false);
			__result->Add(HX_CSTRING("openfl-bitfive") , HX_CSTRING("1.0.5"),false);
			__result->Add(HX_CSTRING("openfl-html5-dom") , HX_CSTRING("1.2.1"),false);
			__result->Add(HX_CSTRING("lime") , HX_CSTRING("0.9.6"),false);
