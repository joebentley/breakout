...
::entities::Brick_obj::__register();
::entities::BarBackdrop_obj::__register();
::entities::Bar_obj::__register();
::entities::Ball_obj::__register();
...
::entities::Ball_obj::__boot();
::entities::Bar_obj::__boot();
::entities::BarBackdrop_obj::__boot();
::entities::Brick_obj::__boot();
::entities::Player_obj::__boot();
