...
#define INCLUDED_entities_Brick
...
HX_DECLARE_CLASS1(entities,Brick)
namespace entities{


class HXCPP_CLASS_ATTRIBUTES  Brick_obj : public ::com::haxepunk::Entity_obj{
	public:
	...
	public:
		...
		static hx::ObjectPtr< Brick_obj > __new(int x,int y);
