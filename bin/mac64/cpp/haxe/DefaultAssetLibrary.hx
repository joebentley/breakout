...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("graphics/10.png", __ASSET__graphics_10_png);
		type.set ("graphics/10.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		addExternal("graphics/10.png", "image", "graphics/10.png");
...
@:keep class __ASSET__graphics_10_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
