...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("graphics/ball.png", __ASSET__graphics_ball_png);
		...
		className.set ("graphics/brick.png", __ASSET__graphics_brick_png);
		...
		className.set ("graphics/paddle.png", __ASSET__graphics_paddle_png);
		type.set ("graphics/paddle.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("audio/death.wav", __ASSET__audio_death_wav);
		type.set ("audio/death.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("audio/shot.wav", __ASSET__audio_shot_wav);
		type.set ("audio/shot.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("audio/song.ogg", __ASSET__audio_song_ogg);
		type.set ("audio/song.ogg", Reflect.field (AssetType, "music".toUpperCase ()));
		className.set ("audio/tink.wav", __ASSET__audio_tink_wav);
		...
		addExternal("graphics/back.png", "image", "graphics/back.png");
		addExternal("graphics/ball.png", "image", "graphics/ball.png");
		addExternal("graphics/bar.png", "image", "graphics/bar.png");
		addExternal("graphics/brick.png", "image", "graphics/brick.png");
		addExternal("graphics/bullet.png", "image", "graphics/bullet.png");
		addExternal("graphics/paddle.png", "image", "graphics/paddle.png");
		addExternal("audio/death.wav", "sound", "audio/death.wav");
		addExternal("audio/shot.wav", "sound", "audio/shot.wav");
		addExternal("audio/song.ogg", "music", "audio/song.ogg");
		addExternal("audio/tink.wav", "sound", "audio/tink.wav");
...
@:keep class __ASSET__graphics_back_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__graphics_ball_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__graphics_bar_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__graphics_brick_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__graphics_bullet_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__graphics_paddle_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__audio_death_wav extends null { }
@:keep class __ASSET__audio_shot_wav extends null { }
@:keep class __ASSET__audio_song_ogg extends null { }
@:keep class __ASSET__audio_tink_wav extends null { }
